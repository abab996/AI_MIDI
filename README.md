...
### One-shot tasks (Workbench)

1. Drag & drop or click to select a MIDI file → click **解析 MIDI** (Parse)
2. Pick a task: **Add Chords / Translate Lyrics / Design Melisma / Custom**
3. Fill in lyrics / requirements, adjust BPM & time signature if needed
4. Click **▶ 开始** (Start) and watch the live console output
